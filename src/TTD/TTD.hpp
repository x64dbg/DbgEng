...
namespace TTD {
	...
	*/
	...
	typedef struct TTD_Replay_ICursor_vftable {
		...
		void* unk1;
#ifdef _WIN64
		struct MemoryBuffer* (__thiscall* QueryMemoryBuffer)(TTD_Replay_ICursor* self, struct MemoryBuffer* memorybuffer_out, GuestAddress, struct TBuffer* buf, unsigned int queryMemoryPolicy);
#else
		struct MemoryBuffer (__thiscall* QueryMemoryBuffer)(TTD_Replay_ICursor* self, GuestAddress, struct TBuffer buf, unsigned int queryMemoryPolicy);
#endif
		...
		void* unk8;
		struct TTD_Replay_ThreadInfo* (__thiscall* GetThreadInfo)(TTD_Replay_ICursor* self, unsigned int ThreadId);
		GuestAddress (__thiscall* GetTebAddress)(TTD_Replay_ICursor* self, unsigned int ThreadId);
		struct Position* (__thiscall* GetPosition)(TTD_Replay_ICursor* self, unsigned int ThreadId);
		...
		struct Position* (__thiscall* GetPreviousPosition)(TTD_Replay_ICursor* self, unsigned int ThreadId);
		GuestAddress(__thiscall* GetProgramCounter)(TTD_Replay_ICursor* self, unsigned int ThreadId);
		...
		void* unk16;
		void* (__thiscall* GetCrossPlatformContext)(TTD_Replay_ICursor* self, void* out, uint32_t threadId);
		struct TTD_Replay_ExtendedRegisterContext* (__thiscall* GetAvxExtendedContext)(TTD_Replay_ICursor* self, struct TTD_Replay_ExtendedRegisterContext* out);
		//  unsigned __int64 (__fastcall *_GetModuleCount_Cursor_Replay_TTD__UEBA_KXZ)(TTD::Replay::Cursor *__hidden this);
		unsigned __int64(__thiscall* GetModuleCount)(TTD_Replay_ICursor* self);
		...
		struct TTD_Replay_ModuleInstance* (__thiscall* GetModuleList)(TTD_Replay_ICursor* self);
		unsigned __int64(__thiscall* GetThreadCount)(TTD_Replay_ICursor* self);
		struct TTD_Replay_ActiveThreadInfo* (__thiscall* GetThreadList)(TTD_Replay_ICursor* self);
		void(__thiscall* SetEventMask)(TTD_Replay_ICursor* self, DWORD eventMask);
		...
		void* unk32;
		bool(__thiscall* AddMemoryWatchpoint)(TTD_Replay_ICursor* self, struct TTD_Replay_MemoryWatchpointData* data);
		bool(__thiscall* RemoveMemoryWatchpoint)(TTD_Replay_ICursor* self, struct TTD_Replay_MemoryWatchpointData* data);
		...
		void* unk37;
		void(__thiscall* SetPosition)(TTD_Replay_ICursor* self, struct Position*);
		void(__thiscall* SetPositionOnThread)(TTD_Replay_ICursor* self, unsigned int uniqueThreadId, struct Position*);
		void (__thiscall *SetMemoryWatchpointCallback)(TTD_Replay_ICursor* self, bool (__fastcall *const)(CallbackValue callback_value, const TTD_Replay_MemoryWatchpointResult* result, struct TTD_Replay_IThreadView* thread_info), CallbackValue callback_value);
		...
		void* unk48;
#ifdef _WIN64
		struct TTD_Replay_ICursorView_ReplayResult* (__thiscall* ReplayForward)(TTD_Replay_ICursor* self, struct TTD_Replay_ICursorView_ReplayResult* replay_result_out, struct Position* posMax, unsigned __int64 stepCount);
		struct TTD_Replay_ICursorView_ReplayResult* (__thiscall* ReplayBackward)(TTD_Replay_ICursor* self, struct TTD_Replay_ICursorView_ReplayResult* replay_result_out, struct Position* posMin, unsigned __int64 stepCount);
#else
		struct TTD_Replay_ICursorView_ReplayResult (__thiscall* ReplayForward)(TTD_Replay_ICursor* self, struct Position posMax, unsigned __int64 stepCount);
		struct TTD_Replay_ICursorView_ReplayResult (__thiscall* ReplayBackward)(TTD_Replay_ICursor* self, struct Position posMin, unsigned __int64 stepCount);
#endif
		void(__thiscall* InterruptReplay)(TTD_Replay_ICursor* self);
		...
		void* unk55;
		void (__thiscall* Destroy)(TTD_Replay_ICursor* self);
	...
	*/
	...
	typedef struct TTD_Replay_IReplayEngine_vftable {
		//const void* (__thiscall* ___7ReplayEngine_Replay_TTD__6BIReplayEngine_12_@)(TTD::Replay::ReplayEngine* __hidden this, const struct _GUID*);
		void* unk1;
		//void* (__thiscall* _UnsafeAsInterface_ReplayEngine_Replay_TTD__UEAAPEAXAEBU_GUID___Z)(TTD::Replay::ReplayEngine* __hidden this, const struct _GUID*);
		void* unk2;
		GuestAddress(*GetPebAddress)(TTD_Replay_ReplayEngine* self);
		struct TTD_SystemInfo* (__thiscall* GetSystemInfo)(TTD_Replay_ReplayEngine* self);
		struct Position* (__thiscall* GetFirstPosition)(TTD_Replay_ReplayEngine* self);
		struct Position* (__thiscall* GetLastPosition)(TTD_Replay_ReplayEngine* self);
		//const struct Position* (__thiscall* anonymous_0)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk7;
		//	enum RecordingType(__thiscall* _GetRecordingType_ReplayEngine_Replay_TTD__UEBA_AW4RecordingType_23_XZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk8;
		...
		void* unk9;
		unsigned __int64(__thiscall* GetThreadCount)(TTD_Replay_ReplayEngine* self);
		TTD_Replay_ThreadInfo* (__thiscall* GetThreadList)(TTD_Replay_ReplayEngine* self);
		//	const unsigned __int64* (__thiscall* _GetThreadFirstPositionIndex_ReplayEngine_Replay_TTD__UEBAPEB_KXZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk12;
		//	const unsigned __int64* (__thiscall* _GetThreadLastPositionIndex_ReplayEngine_Replay_TTD__UEBAPEB_KXZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk13;
		//	const unsigned __int64* (__thiscall* _GetThreadLifetimeFirstPositionIndex_ReplayEngine_Replay_TTD__UEBAPEB_KXZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk14;
		//	const unsigned __int64* (__thiscall* _GetThreadLifetimeLastPositionIndex_ReplayEngine_Replay_TTD__UEBAPEB_KXZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk15;
		unsigned __int64(__thiscall* GetThreadCreatedEventCount)(TTD_Replay_ReplayEngine* self);
		const TTD_Replay_ThreadCreatedEvent* (__thiscall* GetThreadCreatedEventList)(TTD_Replay_ReplayEngine* self);
		unsigned __int64(__thiscall* GetThreadTerminatedEventCount)(TTD_Replay_ReplayEngine* self);
		const TTD_Replay_ThreadTerminatedEvent* (__thiscall* GetThreadTerminatedEventList)(TTD_Replay_ReplayEngine* self);
		unsigned __int64(__thiscall* GetModuleCount)(TTD_Replay_ReplayEngine* self);
		const TTD_Replay_Module* (__thiscall* GetModuleList)(TTD_Replay_ReplayEngine* self);
		//	unsigned __int64(__thiscall* _GetModuleInstanceCount_ReplayEngine_Replay_TTD__UEBA_KXZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk22;
		//	const struct TTD::Replay::ModuleInstance* (__thiscall* _GetModuleInstanceList_ReplayEngine_Replay_TTD__UEBAPEBUModuleInstance_23_XZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk23;
		//	const unsigned __int64* (__thiscall* _GetModuleInstanceUnloadIndex_ReplayEngine_Replay_TTD__UEBAPEB_KXZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk24;
		//	unsigned __int64(__thiscall* _GetModuleLoadedEventCount_ReplayEngine_Replay_TTD__UEBA_KXZ)(TTD::Replay::ReplayEngine* __hidden this);
		unsigned __int64(__thiscall* GetModuleLoadedEventCount)(TTD_Replay_ReplayEngine* self);
		const TTD_Replay_ModuleLoadedEvent* (__thiscall* GetModuleLoadedEventList)(TTD_Replay_ReplayEngine* self);
		unsigned __int64(__thiscall* GetModuleUnloadedEventCount)(TTD_Replay_ReplayEngine* self);
		const TTD_Replay_ModuleUnloadedEvent* (__thiscall* GetModuleUnloadedEventList)(TTD_Replay_ReplayEngine* self);
		unsigned __int64(__thiscall* GetExceptionEventCount)(TTD_Replay_ReplayEngine* self);;
		const TTD_Replay_ExceptionEvent* (__thiscall* GetExceptionEventList)(TTD_Replay_ReplayEngine* self);
		//	const struct TTD::Replay::ExceptionEvent* (__thiscall* _GetExceptionAtOrAfterPosition_ReplayEngine_Replay_TTD__UEBAPEBUExceptionEvent_23_AEBUPosition_23__Z)(TTD::Replay::ReplayEngine* __hidden this, const struct Position*);
		void* unk31;
		//	unsigned __int64(__thiscall* _GetKeyframeCount_ReplayEngine_Replay_TTD__UEBA_KXZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk32;
		//	const struct Position* (__thiscall* _GetKeyframeList_ReplayEngine_Replay_TTD__UEBAPEBUPosition_23_XZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk33;
		//	unsigned __int64(__thiscall* _GetRecordClientCount_ReplayEngine_Replay_TTD__UEBA_KXZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk34;
		//	const struct TTD::Replay::RecordClient* (__thiscall* _GetRecordClientList_ReplayEngine_Replay_TTD__UEBAPEBURecordClient_23_XZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk35;
		...
		void* unk36;
		//	unsigned __int64(__thiscall* _GetCustomEventCount_ReplayEngine_Replay_TTD__UEBA_KXZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk37;
		//	const struct TTD::Replay::CustomEvent* (__thiscall* _GetCustomEventList_ReplayEngine_Replay_TTD__UEBAPEBUCustomEvent_23_XZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk38;
		//	unsigned __int64(__thiscall* _GetActivityCount_ReplayEngine_Replay_TTD__UEBA_KXZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk39;
		//	const struct TTD::Replay::Activity* (__thiscall* _GetActivityList_ReplayEngine_Replay_TTD__UEBAPEBUActivity_23_XZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk40;
		//	unsigned __int64(__thiscall* _GetIslandCount_ReplayEngine_Replay_TTD__UEBA_KXZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk41;
		//	const struct TTD::Replay::Island* (__thiscall* _GetIslandList_ReplayEngine_Replay_TTD__UEBAPEBUIsland_23_XZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk42;
		struct TTD_Replay_ICursor* (__thiscall* NewCursor)(TTD_Replay_ReplayEngine* self, const unsigned char* guid);
		...
		void* unk46;
		//	__int64(__thiscall* _RegisterDebugModeAndLogging_ReplayEngine_Replay_TTD__UEAAXW4DebugModeType_23_PEAVErrorReporting_3__Z)(__int64, int, __int64);
		void* unk47;
		//	const struct TTD::Replay::IEngineInternals* (__thiscall* _GetInternals_ReplayEngine_Replay_TTD__UEBAPEBVIEngineInternals_23_XZ)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk48;
		//	const struct TTD::Replay::IEngineInternals* (__thiscall* anonymous_1)(TTD::Replay::ReplayEngine* __hidden this);
		void* unk49;
		//	void* (__thiscall* ___EReplayEngine_Replay_TTD__UEAAPEAXI_Z)(TTD::Replay::ReplayEngine* __hidden this, unsigned int);
		void* unk50;
		void (__thiscall* Destroy)(TTD_Replay_ReplayEngine* self);
		bool(__thiscall* Initialize)(TTD_Replay_ReplayEngine* self, const wchar_t* trace_filename);
	...
	typedef struct TTD_Replay_IThreadView_vftable {
		...
		struct TTD_Replay_ThreadInfo*(__thiscall* GetThreadInfo)(TTD_Replay_IThreadView* self);
		// offset TTD::Replay::ExecutionState::GetTebAddress(void)
		void* unk2;
		Position* (__thiscall* GetPosition)(TTD_Replay_IThreadView* self);
		// TTD::Replay::ExecutionState::GetPreviousPosition(void)
		void* unk4;
		GuestAddress(__thiscall* GetProgramCounter)(TTD_Replay_IThreadView* self);
	 ...
	 */
	typedef bool(__fastcall* const PROC_MemCallback)(CallbackValue callback_value, const TTD_Replay_MemoryWatchpointResult* result, struct TTD_Replay_IThreadView* thread_info);

	class Cursor {

	private:
		TTD_Replay_ICursor* cursor = nullptr;
	public:
		...
		void SetPositionOnThread(unsigned int uniqueThreadId, Position* position);
		...
		GuestAddress GetTebAddress(unsigned int ThreadId = 0);
		...
		size_t ReadMemoryPartial(GuestAddress address, void* dst, size_t size);
	...
	public:
		...
		unsigned __int64 GetThreadCount();
		const TTD_Replay_ThreadInfo* GetThreadList();
